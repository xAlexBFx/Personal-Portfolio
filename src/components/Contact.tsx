        ...
        <div className="grid lg:grid-cols-2 gap-16">
          <div className="space-y-8">
            ...
            <div className="flex space-x-4">
              <ScrollReveal animation="scale" delay={200} className="flex-1">
                <a href="https://www.linkedin.com/in/alex-betances-1435b6361/" className="group flex-1 bg-gradient-to-br from-background/50 to-muted/50 backdrop-blur-sm p-6 rounded-xl border border-border/50 hover:border-slate-400/50 transition-all duration-300 text-center block">
                  <div className="text-slate-300 font-bold text-lg group-hover:text-foreground transition-colors duration-300">LinkedIn</div>
                </a>
              </ScrollReveal>
              <ScrollReveal animation="scale" delay={300} className="flex-1">
                <a href="https://github.com/xAlexBFx" className="group flex-1 bg-gradient-to-br from-background/50 to-muted/50 backdrop-blur-sm p-6 rounded-xl border border-border/50 hover:border-gray-400/50 transition-all duration-300 text-center block">
